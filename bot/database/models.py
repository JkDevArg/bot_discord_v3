...
class BackupLog(Base):
    """Registro de backups de la base de datos"""
...
class BotConfig(Base):
    ...
    daily_week_bonus = Column(Integer, default=100, nullable=False)
    daily_month_bonus = Column(Integer, default=500, nullable=False)
    ...
    shop_tax_rate = Column(Float, default=0.0, nullable=False)
